                ...
                try:
                    ...
                    with st.expander("📊 Productos Normalizados (Vista previa)", expanded=True):
                        if process_result['products']:
                            ...
                            # 🔥 Limpiar columnas de metadata para la vista previa
                            cols_to_show = ['codigo', 'nombre_articulo', 'precio_lista', 'marca', 'modelo']
                    ...
                    # 🔥 b) Eliminar columnas de metadata (hoja_origen y confianza_ia)
                    cols_to_drop = ['hoja_origen', 'confianza_ia']
